...
class Styles extends Base {
	...
	public static function styles(): string {
        $SVG_Brush = <<<HTML
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 381 14.2">
        ...
        $SVG_Brush = encode_svg_data( $SVG_Brush );

        $SVG_Marker = <<<HTML
            <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" viewBox="0 0 400 60">
        ...
        $inline = "
            ...
            .has-decoration:where(.is-style-brush,.is-style-marker) {
                position: relative;
                z-index: 1;
            }
            .has-decoration:is(.is-style-brush,.is-style-marker) * {
                text-decoration: none;
            }
            .has-decoration:where(.is-style-brush,.is-style-marker)::after {
                content: '';
                position: absolute;
                margin: 0;
            ...
            .has-decoration.is-style-brush::after {
                ...
                width: 100%;
                max-width: 100%;
                -webkit-mask: url('$SVG_Brush') center 100% no-repeat;
                mask: url('$SVG_Brush') 100% center no-repeat;
            }
